...
declare module 'node-forge' {
  ...
  namespace jsbn {
    export class BigInteger {
      constructor(n: string | Array<number> | Buffer)
      ...
      abs(): BigInteger
      add(m: BigInteger): BigInteger
      compareTo(m: BigInteger): number
      mod(m: BigInteger): BigInteger
      modInverse(n: BigInteger): BigInteger
      modPow(exponent: BigInteger, m: BigInteger): BigInteger
      multiply(m: BigInteger): BigInteger
      subtract(m: BigInteger): BigInteger
